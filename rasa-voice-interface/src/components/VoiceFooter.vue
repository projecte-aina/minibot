...
#app footer {
	...
	.start-button {
		...
		border: none;
		box-shadow: -10px -10px 15px rgb(31, 84, 128) inset,
			-1px -1px 15px rgba(0, 0, 0, 0.8);
		background: rgb(31, 84, 128);
		background: -moz-linear-gradient(151deg, rgb(44, 160, 213) 0%, rgb(31, 84, 128) 89%);
		background: -webkit-linear-gradient(151deg, rgb(44, 160, 213) 0%, rgb(31, 84, 128) 89%);
		background: linear-gradient(151deg, rgb(44, 160, 213) 0%, rgb(31, 84, 128) 89%);
